...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public DcMotorEx leftFront, leftRear, rightRear, rightFront, flywheelOne, flywheelTwo;
    public DcMotor intake, arm;
    public Servo index, grab, block;
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        flywheelOne = (DcMotorEx) hardwareMap.dcMotor.get("f1");
        flywheelTwo = (DcMotorEx) hardwareMap.dcMotor.get("f2");
